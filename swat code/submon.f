...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      real*8, dimension (11) :: ssub_av      !added by Yuzhuang Chen 2021/03/06
      
      do sb = 1, subtot
        
       !add by Yuzhuang Chen 
       !! calculate monthly averages where applicable  
        ssub_av = 0.
        ssub_av(1) = submono(21,sb) / dfloat(mdays)    !mdays number of days in the month
        !add by Yuzhuang Chen 
...
!!      added for jennifer b.
        ...
        pdvab(25) = ssub_av(1)  !! monthly average sub_sno (subbasin subbasin snow depth in H2O) is added by Yuzhuang Chen 2021/03/26
...
! 1000 format ('BIGSUB',i5,1x,i8,1x,i4,e10.5,18f10.3,1x,e10.5,5e10.3)    !comment by Yuzhuang Chen
 1000 format ('BIGSUB',i5,1x,i8,1x,i4,e10.5,18f10.3,1x,e10.5,5e10.3,1x,   !added by Yuzhuang Chen 2021/03/25
