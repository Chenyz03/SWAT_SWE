...
!! initialize variables    
      ...
      mhruo = 79
      mrcho = 62
!      msubo = 24               !!comment by Yuzhuang Chen 2021/03/25
      msubo = 25               !!max number of variables in output.sub file      added by Yuzhuang Chen 
      mstdo = 113
...
!      allocate (hqd(nstep*3+1))  !! was 73, changed for urban
  ...
  !!    allocate (hqdsave(msub,49))
      ...
      allocate (sub_sno(msub))     !sub_sno (subbasin subbasin snow depth in H2O) is added by Yuzhuang Chen 2021/03/23  
