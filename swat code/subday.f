...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      pdvab(25) = sub_sno(sb)    !! !sub_sno (subbasin snow depth in H2O) is added by Yuzhuang Chen 2021/03/23
...
!!    added for binary files 3/25/09 gsm line below and write (66666
     ...
     &                                        (pdvb(ii), ii = 1, itotb)
        ...
        if (icalen == 0)write(31,1000) sb, subgis(sb), iida, sub_km(sb),      !31="output.sub"   msubo=max number of variables in output.sub file    Yuzhuang Chen
     &                                (pdvab(ii), ii = 1, msubo)
        if (icalen == 1)write(31,1001) sb, subgis(sb), i_mo, icl(iida), 
...
! 1000 format ('BIGSUB',i5,1x,i8,1x,i4,e10.5,18e10.3,1x,e10.5,5e10.3)          !comment by Yuzhuang Chen
! 1001 format('BIGSUB',i5,1x,i8,1x,i2,1x,i2,1x,i4,1x,e10.5,18e10.3,1x,         !comment by Yuzhuang Chen
!    &  e10.5, 5e10.3)                                                         !comment by Yuzhuang Chen
 1000 format ('BIGSUB',i5,1x,i8,1x,i4,e10.5,18e10.3,1x,e10.5,5e10.3,1x,        !added by Yuzhuang Chen 2021/03/25
     & e10.3)                                                                 !added by Yuzhuang Chen 
 1001 format('BIGSUB',i5,1x,i8,1x,i2,1x,i2,1x,i4,1x,e10.5,18e10.3,1x, 
     & e10.5, 5e10.3,1x,e10.3)                                                !added by Yuzhuang Chen
      end 