...
! msub = max number of subbasins
      ...
      real*8, dimension (:), allocatable :: sub_snom,sub_qd,sub_sedy,sub_sno  !sub_sno (subbasin subbasin snow depth in H2O) is added by Yuzhuang Chen 2021/03/23  
...
!!    adding qtile to output.hru write 3/2/2010 gsm  increased heds(70) to heds(71)
      !character(len=13) :: heds(79),hedb(24),hedr(46),hedrsv(41)      !commment by Yuzhuang Chen 
      character(len=13) :: heds(79),hedb(25),hedr(46),hedrsv(41)       !added by Yuzhuang Chen 2021/03/23
