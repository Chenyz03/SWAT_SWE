...
!1031    format (//6x,' SUB      GIS  MO DA  YR   AREAkm2',24(a10))      !commment by Yuzhuang Chen
1031    format (//6x,' SUB      GIS  MO DA  YR   AREAkm2',25(a10))       !added by Yuzhuang Chen 2021/03/23  
      endif
...
!bmp-ri.out
 ...
 1021  format (//'LULC  HRU       GIS  SUB  MGT MO DA   YR',            
     &'   AREAkm2', 79(a10))	   
 !1030 format (//6x,' SUB      GIS  MON   AREAkm2',24(a10))   !commment by Yuzhuang Chen
 1030 format (//6x,' SUB      GIS  MON   AREAkm2',25(a10))    !added by Yuzhuang Chen 2021/03/23
